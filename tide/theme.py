...
DARK = dict(
    ...
    TREE_DIR=117, TREE_FILE=250, TREE_SEL_BG=24,
...
MIDNIGHT = dict(
    ...
    TREE_DIR=110, TREE_FILE=248, TREE_SEL_BG=17,
    TERM_BG=232, TERM_FG=251,
    GIT_LINE_MODIFIED=75,
...
EMBER = dict(
    ...
    TREE_DIR=109, TREE_FILE=223, TREE_SEL_BG=239,
...
LIGHT = dict(
    ...
    TREE_DIR=26, TREE_FILE=238, TREE_SEL_BG=153,
