...
M_DARK = dict(
    ...
    GUTTER_BG=235, SCROLL_TRACK=237, SCROLL_THUMB=240, SCROLL_THUMB_HL=248,
    TAB_ACTIVE_BG=238, TAB_ACTIVE_FG=253, TAB_BG=235, TAB_FG=243,
    STATUS_BG=235, STATUS_FG=250, STATUS_ACC=39,
    TREE_SEL_BG=237, TERM_BG=235, GIT_IGNORED=245,
)
...
M_ALIEN = dict(
    ...
    SCROLL_TRACK=234, SCROLL_THUMB=239, SCROLL_THUMB_HL=190,
    TAB_ACTIVE_BG=236, TAB_ACTIVE_FG=190, TAB_BG=232, TAB_FG=243, TAB_MARK=213,
    STATUS_BG=232, STATUS_FG=190, STATUS_ACC=129,
    TREE_DIR=141, TREE_GUIDE=236, TREE_FILE=250, TREE_SEL_BG=53,
    ERROR=197, WARN=190, OK=118, GIT_IGNORED=244,
...
M_FOREST = dict(
    ...
    GUTTER_BG=233, LINENO=239, LINENO_CUR=250,
    SELECTION=23, FIND_MATCH=58, FIND_CUR=64,
    SCROLL_TRACK=235, SCROLL_THUMB=239, SCROLL_THUMB_HL=248,
    TAB_ACTIVE_BG=237, TAB_ACTIVE_FG=252, TAB_BG=233, TAB_FG=244, TAB_MARK=180,
    STATUS_BG=233, STATUS_FG=252, STATUS_ACC=72,
    TREE_DIR=109, TREE_GUIDE=236, TREE_FILE=250, TREE_SEL_BG=23,
    ERROR=167, WARN=180, OK=108, GIT_IGNORED=244,
...
M_LIGHT = dict(
    ...
    GUTTER_BG=255, SCROLL_TRACK=253, SCROLL_THUMB=249, SCROLL_THUMB_HL=240,
    TAB_ACTIVE_BG=252, TAB_ACTIVE_FG=232, TAB_BG=255, TAB_FG=245,
    STATUS_BG=255, STATUS_FG=238, STATUS_ACC=32,
    TREE_SEL_BG=252, GIT_IGNORED=246,
)

# "parchment" - dark, but warm: beige, ochre and old paper
M_PARCHMENT = dict(
    M_DARK,
    BG=234, BG_ALT=235, PANEL=234, PANEL_ALT=234, TERM_BG=234,
    FG=187, FG_DIM=101, BORDER=240, BORDER_HL=179,
    GUTTER_BG=234, LINENO=240, LINENO_CUR=180,
    SELECTION=58, FIND_MATCH=94, FIND_CUR=136,
    SCROLL_TRACK=236, SCROLL_THUMB=101, SCROLL_THUMB_HL=180,
    TAB_ACTIVE_BG=237, TAB_ACTIVE_FG=223, TAB_BG=234, TAB_FG=101, TAB_MARK=179,
    STATUS_BG=234, STATUS_FG=223, STATUS_ACC=179,
    TREE_DIR=180, TREE_GUIDE=237, TREE_FILE=187, TREE_SEL_BG=58,
    ERROR=167, WARN=179, OK=143, GIT_IGNORED=245,
    GIT_UNTRACKED=143, GIT_ADDED=143, GIT_MODIFIED=179, GIT_DELETED=167,
    GIT_RENAMED=179, GIT_CONFLICT=175,
    GIT_LINE_ADDED=143, GIT_LINE_MODIFIED=180, GIT_LINE_DELETED=167,
    TOK_TEXT=187, TOK_COMMENT=101, TOK_STRING=180, TOK_NUMBER=144,
    TOK_KEYWORD=179, TOK_CONTROL=173, TOK_TYPE=187, TOK_FUNCTION=222,
    TOK_BUILTIN=180, TOK_CONSTANT=179, TOK_OPERATOR=187, TOK_PUNCT=144,
    TOK_PREPROC=173, TOK_ATTR=222, TOK_PROPERTY=187, TOK_HEADING=179,
    TOK_LINK=180, TOK_EMPH=187, TOK_STRONG=223, TOK_TAG=179, TOK_INVALID=167,
)

# "octopus" - deep purple on black, with light grey to read by
M_OCTOPUS = dict(
    M_DARK,
    BG=233, BG_ALT=234, PANEL=233, PANEL_ALT=233, TERM_BG=233,
    FG=252, FG_DIM=245, BORDER=237, BORDER_HL=141,
    GUTTER_BG=233, LINENO=239, LINENO_CUR=183,
    SELECTION=54, FIND_MATCH=53, FIND_CUR=90,
    SCROLL_TRACK=235, SCROLL_THUMB=239, SCROLL_THUMB_HL=141,
    TAB_ACTIVE_BG=237, TAB_ACTIVE_FG=183, TAB_BG=233, TAB_FG=245, TAB_MARK=141,
    STATUS_BG=233, STATUS_FG=183, STATUS_ACC=93,
    TREE_DIR=141, TREE_GUIDE=236, TREE_FILE=250, TREE_SEL_BG=54,
    ERROR=168, WARN=179, OK=114, GIT_IGNORED=244,
    GIT_UNTRACKED=114, GIT_ADDED=114, GIT_MODIFIED=183, GIT_DELETED=168,
    GIT_RENAMED=183, GIT_CONFLICT=176,
    GIT_LINE_ADDED=114, GIT_LINE_MODIFIED=141, GIT_LINE_DELETED=168,
    TOK_TEXT=252, TOK_COMMENT=241, TOK_STRING=182, TOK_NUMBER=189,
    TOK_KEYWORD=141, TOK_CONTROL=134, TOK_TYPE=183, TOK_FUNCTION=252,
    TOK_BUILTIN=147, TOK_CONSTANT=141, TOK_OPERATOR=250, TOK_PUNCT=245,
    TOK_PREPROC=134, TOK_ATTR=189, TOK_PROPERTY=147, TOK_HEADING=141,
    TOK_LINK=147, TOK_EMPH=252, TOK_STRONG=183, TOK_TAG=141, TOK_INVALID=168,
)
...
APPEARANCES = {
    ...
    'modern': {'dark': M_DARK, 'alien': M_ALIEN, 'forest': M_FOREST,
               'parchment': M_PARCHMENT, 'octopus': M_OCTOPUS,
               'light': M_LIGHT},
}
